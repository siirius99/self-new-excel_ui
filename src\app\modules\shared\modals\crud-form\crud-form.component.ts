    ...
    if (this.formGroup.valid) {
      ...
      if(this.data.action=='add'){
        ...
        this.sharedService.postCrudData(this.data.page,formValue).subscribe({
          next: (res)=>{
            this.logger.log(`${this.data.page} added successfully.`)
            this.toast.success(res.message)
            this.dialogRef.close(true);
          },
          error: (error)=>{
            this.logger.error(`${this.data.page} add failed`,error)
        ...
        this.sharedService.putCrudData(this.data.page,this.data.data[this.data.primaryKey],formValue).subscribe({
          next: (res)=>{
            this.logger.log(`${this.data.page} edited successfully.`)
            this.toast.success(res.message)
            this.dialogRef.close(true);
          },
          error: (error)=>{
            this.logger.error(`${this.data.page} edit failed`,error)
            this.toast.error(error)
            this.submitted=false
          }
        })
